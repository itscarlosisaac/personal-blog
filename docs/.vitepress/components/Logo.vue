<template>
  <a :href="withBase('/')" class="logo" :class="{ collapsed }">
    <svg class="logo-icon" viewBox="0 0 44 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <line class="electron" x1="0" y1="12" x2="44" y2="12" stroke="#18181b" stroke-width="1.5"
...
.band1 {
  animation: b1 1.6s linear infinite;
}

.band2 {
  animation: b2 1.6s linear infinite;
}

.band3 {
  animation: b3 1.6s linear infinite;
}
